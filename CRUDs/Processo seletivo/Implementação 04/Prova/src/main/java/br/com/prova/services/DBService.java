...
public class DBService {
	...
	public void instanciarDB() {
		...
		String franquiaVolei = "Volei";
		String franquiaBasquete = "Basquete";
		...
		Integrante integrante3 = new Integrante(franquiaBasquete, "Caça Rato", "Ponta", composicaoTime2000);
		Integrante integrante4 = new Integrante(franquiaFutebol, "W. Rato", "Atacante", composicaoTime2001);
		Integrante integrante5 = new Integrante(franquiaVolei, "Dentinho", "Meia", composicaoTime2001);
		Integrante integrante6 = new Integrante(franquiaBasquete, "Romarinho", "Atacante", composicaoTime2001);
		Integrante integrante7 = new Integrante(franquiaVolei, "Matheus Ferreira", "Meia", composicaoTime2004);
		Integrante integrante8 = new Integrante(franquiaFutebol, "Roberto Dinamite", "Meia", composicaoTime2004);
		Integrante integrante9 = new Integrante(franquiaVolei, "Pedro Queixada", "Atacante", composicaoTime2004);
		...
		//ComposicaoDosTimes (Estava dando Erro de recursão infinita)
